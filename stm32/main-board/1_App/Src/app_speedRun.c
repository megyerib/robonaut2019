...
static void sRunSetLap1Parameters (void)
{
	paramListSRun.lap1[0].P = 0;	paramListSRun.lap1[0].Kp = 0.001f;	paramListSRun.lap1[0].Kd = 0.12f;	paramListSRun.lap1[0].Speed = 70;	// Fast  //elso egyenes
	paramListSRun.lap1[1].P = 0; 	paramListSRun.lap1[1].Kp = 0.005f;	paramListSRun.lap1[1].Kd = 1.0;		paramListSRun.lap1[1].Speed = 15;	// Slow  //elso balra kanyar
	paramListSRun.lap1[2].P = 0; 	paramListSRun.lap1[2].Kp = 0.001f;	paramListSRun.lap1[2].Kd = 0.1f;	paramListSRun.lap1[2].Speed = 70;	// Fast  //masodik egyenes
	paramListSRun.lap1[3].P = 0; 	paramListSRun.lap1[3].Kp = 0.01f;	paramListSRun.lap1[3].Kd = 1.0f;	paramListSRun.lap1[3].Speed = 15;	// Slow  //elso kanyarkombinacio
	paramListSRun.lap1[4].P = 0; 	paramListSRun.lap1[4].Kp = 0.001f;	paramListSRun.lap1[4].Kd = 0.12f;	paramListSRun.lap1[4].Speed = 70;	// Fast  //masodik egyenes
	paramListSRun.lap1[5].P = 0; 	paramListSRun.lap1[5].Kp = 0.01f;	paramListSRun.lap1[5].Kd = 1.0f;	paramListSRun.lap1[5].Speed = 15;	// Slow  //masodik kanyarkombinacio
	paramListSRun.lap1[6].P = 0; 	paramListSRun.lap1[6].Kp = 0.001f;	paramListSRun.lap1[6].Kd = 0.12f;	paramListSRun.lap1[6].Speed = 70;	// Fast  //lefele egyenes
	paramListSRun.lap1[7].P = 0; 	paramListSRun.lap1[7].Kp = 0.005f;	paramListSRun.lap1[7].Kd = 1.0f;	paramListSRun.lap1[7].Speed = 15;	// Slow  //utolsó jobbkanyar
	paramListSRun.lap1[8].P = 0; 	paramListSRun.lap1[8].Kp = 0.001f;	paramListSRun.lap1[8].Kd = 0.12f;	paramListSRun.lap1[8].Speed = 70;	// Fast
