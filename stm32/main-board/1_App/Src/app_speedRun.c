...
static void sRunSetLap1Parameters (void)
{
	...
	paramListSRun.lap1[1].P = 0; 	paramListSRun.lap1[1].Kp = 0.001f;	paramListSRun.lap1[1].Kd = 0.15f;	paramListSRun.lap1[1].Speed = 24;	// Slow
	paramListSRun.lap1[2].P = 0; 	paramListSRun.lap1[2].Kp = 0.001f;	paramListSRun.lap1[2].Kd = 0.1f;	paramListSRun.lap1[2].Speed = 70;	// Fast
	paramListSRun.lap1[3].P = 0; 	paramListSRun.lap1[3].Kp = 0.007f;	paramListSRun.lap1[3].Kd = 1.0f;	paramListSRun.lap1[3].Speed = 18;	// Slow
	...
	paramListSRun.lap1[7].P = 0; 	paramListSRun.lap1[7].Kp = 0.007f;	paramListSRun.lap1[7].Kd = 1.0f;	paramListSRun.lap1[7].Speed = 16;	// Slow
